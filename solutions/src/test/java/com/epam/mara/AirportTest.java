...
import com.epam.mara.clean_code.Airport;
import com.epam.mara.clean_code.Planes.ExperimentalPlane;
...
import com.epam.mara.clean_code.Planes.MilitaryPlane;
import com.epam.mara.clean_code.Planes.PassengerPlane;
import com.epam.mara.clean_code.Planes.Plane;
...
public class AirportTest {
    private static List<Plane> planes = Arrays.asList(
            ...
            new ExperimentalPlane("Bell X-14", 277, 482, 500, ExperimentalPlaneTypes.HIGH_ALTITUDE, ExperimentalPlaneClassificationLevels.SECRET),
            new ExperimentalPlane("Ryan X-13 Vertijet", 560, 307, 500, ExperimentalPlaneTypes.VTOL, ExperimentalPlaneClassificationLevels.TOP_SECRET)
    );
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        for (MilitaryPlane militaryPlane : transportMilitaryPlanes) {
            if ((militaryPlane.getMilitaryPlaneType() == MilitaryPlaneTypes.TRANSPORT)) {
                flag = true;
                break;
            }
        }
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        for (MilitaryPlane militaryPlane : bomberMilitaryPlanes) {
            if ((militaryPlane.getMilitaryPlaneType() == MilitaryPlaneTypes.BOMBER)) {
                flag = true;
                break;
            }
        }
    ...
    @Test
    public void testHasNoClassificationLevelUnclassifiedInExperimentalPlanes(){
        Airport airport = new Airport(planes);
        List<ExperimentalPlane> experimentalPlanes = airport.getExperimentalPlanes();
        boolean hasUnclassifiedPlanes = false;
        for(ExperimentalPlane experimentalPlane : experimentalPlanes){
            if(experimentalPlane.getClassificationLevel() == ExperimentalPlaneClassificationLevels.UNCLASSIFIED){
